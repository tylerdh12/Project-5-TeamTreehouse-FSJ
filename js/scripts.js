...
let userData;
const numberOfPeople = 100; // Sets the Number of people generated by the api endpoint
...
fetch(`https://randomuser.me/api/?results=${numberOfPeople}&nat=us&inc=name,location,email,dob,phone,picture`)
    .then( data => data.json())
